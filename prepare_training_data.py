...
from helper_functions import binarise_image
#

def convert_maths_image_to_skeleton(file):
    inverted = 255 - file
    ...
    resized = resize_to_28_x_28(dilated)
    _, rethresholded = cv2.threshold(resized, 16, 255, cv2.THRESH_BINARY)
